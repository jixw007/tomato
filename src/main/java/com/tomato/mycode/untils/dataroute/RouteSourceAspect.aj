...
@Aspect
@Component
public aspect RouteSourceAspect {
    /**
     * 切点表达式:
     * ..两个点表明多个，*代表一个
     ...
     */
    private final String POINT_CUT2 = "execution(public Apple com.tomato.mycode.service.ApppleService.getApple2ById(..))";
    ...
    public void doAfter(JoinPoint joinPoint) {
        System.out.println("DataSourceAspect::@After：切点方法之后执行.....");
    }
    ...
    public void doAfter(JoinPoint joinPoint, Object result) {
        System.out.println("DataSourceAspect::@AfterReturning：切点方法返回后执行.....");
        System.out.println("DataSourceAspect::返回值：" + result);
    }
    ...
    public void doAfterThrowing(JoinPoint joinPoint, Throwable exception) {
        System.out.println("DataSourceAspect::@afterThrowing：切点方法抛异常执行.....");
    }
    ...
    public Object doAround(ProceedingJoinPoint pjp) throws Throwable {
        System.out.println("DataSourceAspect::@Around：切点方法环绕start.....");
        Object[] args = pjp.getArgs();
        Object o = pjp.proceed(args);
        System.out.println("DataSourceAspect::@Around：切点方法环绕end.....");
        return o;
    }
}
